...
input_folder_pattern="s3://pilebucketXXXX/results/word_1num_counting/*/part-*"
local_output_path="~/aggregated_results"
s3_output_path="s3://pilebucketXXXX/results/word_1num_counting/aggregated/"
ssh -i $PEM_FILE $ADDR "mkdir -p $local_output_path"
ssh -i $PEM_FILE $ADDR "spark-submit ~/SparkScripts/aggregate_results_word_num.py $input_folder_pattern $local_output_path"
